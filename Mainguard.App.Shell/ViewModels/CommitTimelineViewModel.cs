...
public partial class CommitTimelineViewModel : ViewModelBase, IDisposable
{
    ...
    /// (<see cref="Mainguard.Git.Exceptions.BranchNotMergedException"/>) rather than orphaning its
    ...
    {
        Mainguard.Git.Exceptions.BranchNotMergedException? notMerged = null;
        await RunGitActionAsync(() =>
        {
            ...
            catch (Mainguard.Git.Exceptions.BranchNotMergedException ex) { notMerged = ex; }
        });
