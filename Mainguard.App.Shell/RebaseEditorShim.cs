...
/// <c>GIT_SEQUENCE_EDITOR</c> at <c>Mainguard --rebase-editor &lt;todo&gt;</c> and <c>GIT_EDITOR</c> at
/// <c>Mainguard --rebase-msg &lt;msgDir&gt;</c>; git then execs us with the file it wants edited.
///
...
public static class RebaseEditorShim
{
    ...
    /// <summary>
    /// Copies the todo Mainguard generated over the sequence file git handed us. Returns
    ...
    /// <summary>
    /// Copies the message Mainguard staged for the commit git is currently rewording/squashing over
    ...
    private static int Fail(TextWriter stderr, string reason)
    {
        ...
        try { stderr.WriteLine("Mainguard rebase editor: " + reason); } catch { /* stderr closed */ }
        return Failure;
    }
