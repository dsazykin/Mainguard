...
public sealed record ContainerSpecRequest(
    ...
    // This agent's CONVERSATION stores, bind-mounted at the CLI's own $HOME-relative transcript
    // paths so the record survives a jail that dies without a clean stop.
