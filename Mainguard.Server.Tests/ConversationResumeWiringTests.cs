...
public sealed class ConversationResumeWiringTests
{
    ...
    private const string ResumeArg = "--continue";
    ...
    public async Task AnAdapterThatDeclaresNoConversationPaths_GetsNoMounts()
    {
        ...
        using var rig = ConversationRig.Create(declareConversationPaths: false, declareResumeArg: false);
    ...
    public async Task AResumeWithASurvivingTranscript_StartsTheCLIBackInTheConversation()
    {
        ...
        Assert.Equal(
            ConversationRig.LaunchArgv.Append(ResumeArg).ToArray(),
    ...
    {
        // An absent resumeArg is a STATEMENT (this CLI cannot be told to resume), exactly like an
        // absent baseUrlEnvVar. The transcripts are still mounted; nothing is invented to "use" them.
        using var rig = ConversationRig.Create(declareResumeArg: false);
            ...
            File.WriteAllText(
                ...
                InstalledAdapterMarker.Serialize(new InstalledAdapterMarker(
                    ...
                    ConversationPaths: declareConversationPaths
                        ...
                        : null,
                    ResumeArg: declareResumeArg ? ResumeArg : null)));
