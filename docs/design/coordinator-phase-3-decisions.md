...
## 23. A contract §3.1 change — a worker may ask to widen an approved scope (`rescope`)
...
### 23.1 What was found, measured before anything was changed
...
### 23.2 The op, and why a model will not confuse it with `revise`
...
### 23.3 The budget: a re-scope spends **no** revision, and the argument both ways
...
### 23.4 The store: supersede, not stack — and the F6 trap on the way there
...
### 23.5 Work already done outside the scope: allowed, not re-policed
...
### 23.6 While a re-scope is pending, the worker is **not** blocked
...
### 23.7 The card, which is a different decision from the one it resembles
