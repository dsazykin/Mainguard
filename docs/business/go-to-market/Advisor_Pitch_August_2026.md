...
## 1. Objective — and what "success" actually is
...
## 2. Why this approach (the evidence, compressed)

- **Don't open with "will you be my advisor?"** — it's asking for a relationship before the first
  date (Startups.com). Ask for advice on specific problems; let the advisory role emerge from
  repeated useful sessions.
...
## 3. Before the trip — checklist

- [ ] **Ask for the session in advance**, framed as advice-not-pitch. Template (adapt voice):
  > "While we're visiting in August, could I steal 45–60 minutes of your time? I've been building
  > a developer-tools product for the last year and I'm at the point where a few decisions matter
  > a lot — launch sequencing and how to get the first paying teams. You've done zero-to-one
  > twice; I'd really value your judgment. I'll send a one-pager ahead so I don't waste your time
  > explaining basics."
- [ ] **Research Daemon.** Public search as of 2026-07-06 could not conclusively identify an AI
  startup named "Daemon" (most plausible candidate: daemon.ai, likely stealth; other candidates:
  daemons.ai agent platform, Daemon/dae.mn consultancy, Daemon Automation). Once you have his
  full name: LinkedIn → Crunchbase → any talks/podcasts → his previous company's story (how it
...
- [ ] **Rehearse the 10-minute demo** (GTM plan §10.2) on a laptop that works offline. Scope it
  ...
  will probe exactly where you're vaguest — pre-decide the honest answers to: How many users?
  (none yet — launching Q4, here's the waitlist/design-partner plan.) Why won't Anthropic/Cursor
  kill you? (vendor-neutrality + real Git engine + local-first; rehearse §5.3/§12.1 of the GTM
  plan.) How do you make money? (§8 of the GTM plan, with the Bloop/Terragon failure ledger.)
- [ ] **Prepare your two or three decision questions** (§4). Write them down. They are the agenda.

## 4. The meeting itself (45–60 min)
...
3. **(25–35 min) The decision questions.** Pick 2–3, phrased so his experience is the input:
   - *Sequencing:* "I can launch the free Git client in October and the agent-verification layer
     4–8 weeks later. Would you sequence it that way, or lead with the agent story? How did you
     stage your first launch?"
   - *First customers:* "My plan is 3–5 design-partner teams before charging anyone. How did you
     land your first paying customers at [his previous company] — and what would you do
     differently?"
   - *Bootstrap vs raise:* "Given the field (funded free competitors, platform vendors absorbing
     features), would you bootstrap to revenue or raise a seed on design-partner traction? What
     did raising cost you that you didn't expect?"
   - *(If Daemon overlap is real) The practitioner question:* "How does your team at Daemon
     ...
     faster?" — this is discovery gold *and* the natural bridge to the design-partner ask.
4. **(5 min) Close with one concrete ask** — the smallest, most useful one the conversation
   supports (see §5). Then thank him and stop. Do not stack asks.
...
## 5. The asks, ranked (use at most one, maybe two)

1. **The follow-up loop (always make this one):** "Can I email you in a few weeks with what I did
   with this advice and how it went?" — costs him nothing, establishes the cadence, and is the
   actual mechanism by which advisors happen.
...
4. **Money — never first, never in August.** See §1.

## 6. Formalizing later — FAST norms (so terms are never awkward)
...
## 7. The one-pager pre-read (send 3–5 days ahead)
...
## 8. Mistakes to avoid (the compressed list)
...
3. **If Daemon design-partnership started:** treat his engineers as Track B design partners
   (GTM plan §6.2) — bi-weekly feedback, real repos, and make their fingerprints visible in the
   changelog (advisors advocate for things they shaped).
4. **When the loop has run 2–3 times:** the FAST conversation (§6).
