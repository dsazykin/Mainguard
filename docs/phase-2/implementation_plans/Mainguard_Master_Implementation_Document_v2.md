...
**Market inputs:** `docs/business/market-analysis/Mainguard_Market_Research_v2.md`, `Mainguard_Viability_And_Differentiation_2026-07.md`, `Mainguard_Naming_And_Competitive_Landscape_2026-07.md`, and the per-competitor refresh `Mainguard_Competitor_Research_2026-07-07.md`, plus the second-pass research `Mainguard_MergeLoom_Deep_Dive_2026-07-07.md` (exhaustive feature/pricing dive on the most directly overlapping competitor) and `Mainguard_Feature_Inventory_2026-07-07.md` (complete feature inventory of every competitor incl. classic Git clients, with match/skip rulings). §1.2 records exactly how those findings changed the plan.
