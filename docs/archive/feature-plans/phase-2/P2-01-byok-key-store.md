...
> **ARCHIVED — this shipped.** The feature described below is in the product today; this document
> is the original plan, kept for provenance. It is not a description of current behaviour and not a
> spec to build from. The binding spec is
> [`Mainguard_Master_Implementation_Document_v2.md`](../../../phase-2/implementation_plans/Mainguard_Master_Implementation_Document_v2.md);
> for how the code actually looks now, use [`docs/repo-map/`](../../../repo-map/README.md).
